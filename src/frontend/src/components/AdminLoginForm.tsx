...
const VALID_USERNAME = "Luxyle Indore";
const VALID_PASSWORD = "Luxyle1234";
...
export default function AdminLoginForm({ onSuccess }: AdminLoginFormProps) {
  ...
  const handleSubmit = (e: FormEvent) => {
    ...
    // Simulate brief loading for UX, then validate credentials
    setTimeout(() => {
    ...
    <div className="min-h-screen bg-beige flex items-center justify-center px-6 pt-20 pb-16">
      <div className="max-w-md w-full bg-ivory p-10 shadow-luxury-lg border-t-4 border-gold">
        ...
        <div className="text-center mb-8">
          ...
          <h1 className="font-heading text-4xl text-royal-blue font-light tracking-wide">
            Dashboard Portal
          </h1>
        ...
        <form onSubmit={handleSubmit} className="space-y-6">
          {/* Error Message */}
          {error && (
            <div className="flex items-center gap-2 bg-red-50 border border-red-200 rounded px-4 py-3 text-red-700 font-body text-sm">
