...
const COLLECTION_IMAGES = [
  ...
  {
    url: "https://img.sanishtech.com/u/81f1aea60fd6fe9d51a12ba384647dd8.jpeg",
    label: "Lounge Design",
  },
  {
    url: "https://img.sanishtech.com/u/dfcd47f133fa1694f66376e81a3788ba.jpeg",
    label: "Artisan Crafts",
  },
  {
    url: "https://img.sanishtech.com/u/1803ea59e75d2d8b3b1baba29b3a51f5.jpeg",
    label: "Statement Décor",
  },
  {
    url: "https://img.sanishtech.com/u/c240a10f7b62e426cd381343d3d3686b.jpeg",
...
export default function CollectionGallery() {
  ...
  const prev = () => {
    ...
    setLightboxIndex(
      (lightboxIndex - 1 + COLLECTION_IMAGES.length) % COLLECTION_IMAGES.length,
    );
  };
  ...
  return (
    <section id="collection" className="py-24 bg-ivory px-6">
      <div className="max-w-7xl mx-auto">
        ...
        <div className="text-center mb-14">
          ...
          <p className="font-body text-charcoal/60 mt-6 max-w-xl mx-auto text-sm leading-relaxed">
            Each piece in our collection is thoughtfully selected to bring
        ...
        <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-3">
          {COLLECTION_IMAGES.map((item, i) => (
            <button
              type="button"
              key={item.url}
              className="group relative overflow-hidden aspect-square cursor-pointer w-full"
      ...
      {lightboxIndex !== null && (
        <dialog
          open
          className="fixed inset-0 z-50 bg-charcoal/95 flex items-center justify-center p-0 m-0 max-w-none max-h-none w-full h-full border-0"
