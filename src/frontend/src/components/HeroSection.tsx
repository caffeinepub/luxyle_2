...
export default function HeroSection() {
  ...
  return (
    <section
      ...
      style={{
        backgroundImage:
          "url(/assets/generated/luxyle-hero-bg.dim_1920x1080.png)",
    ...
    >
      ...
      <div className="relative z-10 text-center px-6 max-w-4xl mx-auto animate-fade-in-up">
        ...
        <h1
          ...
          style={{
            textShadow:
              "0 2px 24px oklch(0.08 0.03 260 / 0.9), 0 1px 4px oklch(0.08 0.03 260 / 0.7)",
          }}
        >
          Luxyle
        </h1>
      ...
      <div className="absolute bottom-10 left-1/2 -translate-x-1/2 flex flex-col items-center gap-2 animate-bounce">
        ...
        <span className="font-body text-gold/60 text-xs tracking-widest uppercase">
          Scroll
        </span>
      </div>
    </section>
