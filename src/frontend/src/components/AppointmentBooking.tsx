...
import { useGetBlockedDates, useSubmitAppointment } from "../hooks/useQueries";
      ...
      },
      {
        ...
        onError: (err: Error) => {
          if (err.message?.includes("blocked")) {
            toast.error(
              "This date is blocked. Please select a different date.",
            );
          } else {
      ...
      <section id="appointment" className="py-24 bg-beige px-6">
        <div className="max-w-xl mx-auto text-center">
          ...
          <p className="font-body text-charcoal/70 leading-relaxed">
            Thank you for booking with Luxyle. We will confirm your appointment
            shortly. Our team looks forward to helping you create a beautiful
            space.
          </p>
          <button
            type="button"
      ...
      <div className="max-w-3xl mx-auto">
        ...
        <div className="text-center mb-14">
          ...
          <p className="font-body text-charcoal/60 mt-6 text-sm leading-relaxed">
            Visit our showroom and let our experts guide you through our
        ...
        <form onSubmit={handleSubmit} className="space-y-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            <div>
              <label
                htmlFor="appt-date"
                className="flex items-center gap-2 font-body text-xs tracking-widest uppercase text-charcoal/60 mb-2"
              >
          ...
          <div className="pt-2">
            ...
            <p className="font-body text-xs text-charcoal/40 mt-3">
              * All appointments are subject to confirmation. We'll reach out to
