...
const CONTACT_CARDS = [
  {
    ...
    title: "Our Location",
    content:
      "Aditya Cosmopolitan, Nemawar Rd,\nnear Lakhani Factory,\nIndore, Madhya Pradesh 452001",
    ...
    <>
      ...
      <section className="pt-32 pb-20 bg-royal-blue text-center px-6">
        ...
        <p className="font-body text-ivory/70 mt-6 max-w-xl mx-auto text-sm leading-relaxed">
          Visit our showroom or reach out to us. Our team is here to help you
          create the perfect luxurious space.
        </p>
      </section>
          ...
          {CONTACT_CARDS.map((card) => {
            ...
            return (
              ...
              >
                ...
                <h3 className="font-heading text-xl text-royal-blue font-medium">
                  {card.title}
                </h3>
      ...
      <section className="py-20 bg-beige px-6">
        <div className="max-w-6xl mx-auto grid grid-cols-1 lg:grid-cols-2 gap-12">
          {/* Map */}
          <div>
            <h2 className="font-heading text-3xl text-royal-blue font-light mb-6">
              Find Us
            </h2>
  ...
  if (submitted) {
    return (
      <div className="text-center py-8">
        <p className="font-heading text-2xl text-royal-blue font-light mb-4">
          Message Sent!
        </p>
